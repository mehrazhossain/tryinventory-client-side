    ...
    <div id="blog" className="bg-gray-100 dark:bg-gray-900 px-4 xl:px-4 py-14">
      <div className="mx-auto container">
        <span role="contentinfo">
          <h1
            tabindex="0"
            className="focus:outline-none text-center text-3xl lg:text-5xl tracking-wider text-gray-900 dark:text-white"
          >
        ...
        >
          <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 xl:mx-48 gap-8">
            <div
              tabindex="0"

...
const SignUp = () => {
  return (
    <div>
      <div class="mt-12 flex flex-col items-center mb-32">
        ...
        <div class="w-full flex-1 mt-8">
          ...
          <div class="mx-auto max-w-xs">
            ...
            />
            <button class="mt-5 tracking-wide font-semibold bg-violet-600 text-gray-100 w-full py-4 rounded-lg hover:bg-violet-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
              <svg
                class="w-6 h-6 -ml-2"
                fill="none"
                stroke="currentColor"
